...
describe('add', () => {
  ...
  test('adds more than two numbers', () => {
    expect(calculator.add(2, 6, 19, 35, 24.5)).toBe(86.5);
  });
});
...
describe('subtract', () => {
  ...
  test('subtracts multiple numbers', () => {
    expect(calculator.subtract(10, 4, 10)).toBe(-4);
  });
});
...
describe('multiply', () => {
  ...
  // test('multiplies more numbers outside array', () => {
  //   expect(calculator.multiply([2, 4], 2)).toBe(16);
  // });
});
